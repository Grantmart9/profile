...
export const cvData: CVData = {
  ...
  summary:
    "Full‑Stack Developer, Cloud Engineer & Automation Specialist with 7 + years of experience turning complex hardware‑centric challenges into high‑performance, user‑focused web platforms. Expert in modern front‑end stacks (React, Next.js, TypeScript, Tailwind) and back‑end technologies (Node.js, Python, PostgreSQL). Designed and delivered AI‑enabled, cloud‑native applications on AWS, utilizing Docker, Serverless, and CI/CD pipelines to achieve rapid scalability and cost efficiency. Built production‑grade IoT dashboards, hospital‑automation systems, and PLC/SCADA interfaces that seamlessly connect edge devices (Siemens, Schneider, Aveva) to cloud services via MQTT, MODBUS and REST APIs. Led multi‑disciplinary teams to architect performant front‑ends, optimise API latency (up to 30 % improvement), and automate repetitive workflows for internal engineering tools. Passionate about merging software innovation with hardware automation to create reliable, maintainable solutions that deliver measurable business value.",
  skills: {
    frontend: [
      "React",
      "Next.js",
    ...
    ai: ["OpenAI API", "AI-driven UI Automation", "LLMs", "NLP", "Kilo Code"],
    automation: [
      "web automation",
      "Business Automation",
      "IoT",
  ...
  projects: [
...

    {
      ...
      description:
        "FaithConnect is a comprehensive church management application designed to streamline administrative tasks, facilitate community engagement, and handle financial contributions for religious organizations.",
      technologies: [
        "Next.js",
        "Tailwind CSS",
        "Shadcn",
    ...
    {
      title: "Luxury Living Web App",
      description:
        "Luxury Living is a vacation property management platform that allows property owners to list their rentals and connect with potential guests for bookings and inquiries.",
      technologies: [
        "Next.js",
        "Tailwind CSS",
        "Shadcn",
  ...
  experience: [
    {
      ...
      description:
        "Lead developer for web and mobile apps using React/Next.js, Node.js, PostgreSQL. Designed database and cloud architecture. Conducted R&D and mentored junior devs.",
    },
    {
